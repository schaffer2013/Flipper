...
OPEN_WEATHER_TOKEN = "4fefbca140e12137852767106a7b7cad"
...
print# Set up where we'll be fetching data from
...
while True:
    ...
    if (currentMinute!=minute):
        ...
        if (minute%5==0) or startup:
            ...
            print("Updated")
        #time.sleep(60)  # wait 5 minutes before updating anything again
    else:
        time.sleep(5)
